...
<div class="d-none pt-5 px-4 print-show">
    <div class="row">
        ...
        <div class="col-12 text-center">
            ...
            <p class="h4 text-muted">Powered By.Dede Hidayah</p>
        </div>
    </div><!-- end row -->
</div><!-- end box print -->
...
<b><marquee bgcolor="yellow">SELAMAT DATANG DI TOKO POS KASIR | SILAHKAN TELITI ULANG BARANG YANG SUDAH DI INPUT | TOKO POS KASIR MELAYANI DENGAN SEPENUH HATI DAN SEPENUH JIWA</marquee></b>
<?php 
if(isset($_POST['save'])){
