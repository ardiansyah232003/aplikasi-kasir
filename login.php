...
<link rel="icon" href="icon.ico" type="image/ico">
  <title>APLIKASI KASIR TOKO POS KASIR</title>
  <meta charset="utf-8">
...
<div class="row justify-content-center">
    ...
    <h1 class="h3 text-center mb-3" style="font-weight:600;">TOKO <span class="text-primary">POS KASIR</span></h1>
...
<!-- END: Powered by Ipaddress.is -->
        <div class="text-center small mt-4">
            <p class="text-dark">Aplikasi kasir © <?php echo date('Y');?> - By : <a href="" class="span text-primary text-dark">Dede Hidayah</a></p>
        </div>
    </div>
